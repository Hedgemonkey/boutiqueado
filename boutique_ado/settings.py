...
SECRET_KEY = 'django-insecure-+%p2jl=$2kwcig5-7v1^ogy!v8q^0-w1j1855!8)rs)%3$+=6w'
...
MESSAGE_STORAGE = 'django.contrib.messages.storage.session.SessionStorage'  # Or 'django.contrib.messages.storage.cookie.CookieStorage'
